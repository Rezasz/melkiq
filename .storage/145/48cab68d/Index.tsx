  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-b from-dark-900 via-dark-800 to-dark-900">
        <div className="absolute inset-0 bg-[url('/assets/london-dubai.avif')] bg-cover bg-center opacity-20"></div>
        <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
          <div className="animate-fade-in">
            <h1 className="text-6xl md:text-8xl font-luxury font-bold mb-6">
              <span className="gradient-text">MelkIQ</span>
              <br />
              <span className="gradient-text text-4xl md:text-5xl">ضریب هوشی ملکی</span>
            </h1>
            <p className="text-2xl md:text-3xl mb-4 text-grey-300 font-light">
              بستر هوشمند سرمایه گذاری بین المللی املاک
            </p>
            <p className="text-lg md:text-xl mb-8 text-grey-400 max-w-3xl mx-auto">
              هوش مصنوعی در خدمت شماست تا بهترین انتخاب ویژه شما را با هم پیدا کنید
            </p>
      ...
      <section className="py-20 bg-dark-800">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-luxury font-bold mb-6">
              <span className="gradient-text">چرا MelkIQ<br />ضریب هوشی ملکی؟</span>
            </h2>
            <p className="text-xl text-stone-400 max-w-3xl mx-auto">
      ...
      <section className="py-20 bg-dark-900">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-stone-400 max-w-3xl mx-auto">
              تجربه مشتریان راضی ما از خدمات MelkIQ<br />ضریب هوشی ملکی
            </p>
          </div>
            ...
            {[
              {
                name: "احمد محمدی",
                role: "سرمایه‌گذار",
                comment: "تیم MelkIQ ضریب هوشی ملکی با حرفه‌ای‌ترین شیوه کمکم کردند تا بهترین ملک رو پیدا کنم. واقعاً راضی هستم.",
                rating: 5
              },
              {
                name: "فاطمه رضایی",
      ...
      {/* Footer */}
      <footer className="bg-dark-900 border-t border-grey-400/20 py-12">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              <h3 className="text-2xl font-luxury font-bold gradient-text mb-4">
                MelkIQ<br />ضریب هوشی ملکی
              </h3>
              <p className="text-stone-400 mb-4 max-w-md">
                بستر هوشمند سرمایه گذاری بین المللی املاک که با استفاده از تکنولوژی‌های نوین، بهترین تجربه خرید املاک را به شما ارائه می‌دهد.
              </p>
          ...
          <div className="border-t border-gold-500/20 mt-12 pt-8 text-center">
            <p className="text-stone-400">
              © 2024 MelkIQ ضریب هوشی ملکی. تمامی حقوق محفوظ است.
            </p>
          </div>
        </div>
      </footer>
