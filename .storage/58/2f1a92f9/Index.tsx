  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-b from-navy-900 via-navy-800 to-navy-900">
        <div className="absolute inset-0 bg-[url('https://images.pexels.com/photos/1370704/pexels-photo-1370704.jpeg')] bg-cover bg-center opacity-10"></div>
        <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
          <div className="animate-fade-in">
            <h1 className="text-6xl md:text-8xl font-luxury font-bold mb-6">
              <span className="gradient-text">ایوان پراپرتیز</span>
            </h1>
      ...
      <section className="py-20 bg-navy-800">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-luxury font-bold mb-6">
              <span className="gradient-text">چرا ایوان پراپرتیز؟</span>
            </h2>
            <p className="text-xl text-stone-400 max-w-3xl mx-auto">
      ...
      <section className="py-20 bg-navy-900">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-stone-400 max-w-3xl mx-auto">
              تجربه مشتریان راضی ما از خدمات ایوان پراپرتیز
            </p>
          </div>
            ...
            {[
              {
                name: "احمد محمدی",
                role: "سرمایه‌گذار",
                comment: "تیم ایوان پراپرتیز با حرفه‌ای‌ترین شیوه کمکم کردند تا بهترین ملک رو پیدا کنم. واقعاً راضی هستم.",
                rating: 5
              },
              {
                name: "فاطمه رضایی",
      ...
      <footer className="bg-navy-900 border-t border-gold-500/20 py-12">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="border-t border-gold-500/20 mt-12 pt-8 text-center">
            <p className="text-stone-400">
              © 2024 ایوان پراپرتیز. تمامی حقوق محفوظ است.
            </p>
          </div>
        </div>
      </footer>
